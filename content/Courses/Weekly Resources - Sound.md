...
**Resources**:
- [Tutorial: Signal Generation](https://teaching.alptugan.com/Tutorials/Davinci-Resolve---Generate-Signal)
...
1. Create a complete sound design for a short video, incorporating the diegetic, non-diegetic, and trans-diegetic layers of sound.  
   ...
   **Non-Diegetic or Trans-Diegetic Sound**: Incorporate at least one significant sound effect that is either non-diegetic (e.g., a musical score, stinger, or mood-setting sound not heard by the characters) or trans-diegetic (e.g., a sound that crosses between the world of the characters and the world of the audience, like a character's internal monologue or a highly stylized sound that represents a thought or memory).  
      
2. Export the video with sound in mp4 format. Keep the video resolution 1920x1080 maximum. [Tutorial](https://teaching.alptugan.com/Tutorials/Davinci-Resolve---Video-Export)  
      
3. Upload the videos [Google Drive](https://drive.google.com/drive/folders/1zGbmNFiOwqWqaqOAuv1aZkNKwRoulkB5?usp=sharing), and paste the link on LMS.  
...
[Normalization](https://www.youtube.com/watch?v=nZJkcca7vJ4) 
[Foley Sampler Plug-in](https://teaching.alptugan.com/Tutorials/Davinci-Resolve---Foley-Sampler)
[Automation Curves](https://teaching.alptugan.com/Tutorials/Davinci-Resolve---Automation-Curves)
[Fade-in, fade-out, Cross-fade](https://teaching.alptugan.com/Tutorials/Davinci-Resolve---Cross-fade-Effect)

**Assignment 1 (Practice): 
1. Choose a movie scene or an original shot of your own recordings minimum <font color="#ffc000">10</font> (max <font color="#ffc000">30</font>) seconds long including a repetitive action such as a walking person, running animal, slicing vegetables, etc...

2. Import the video into Davinci Resolve.

3. Determine cue points and identify required sound samples with time stamps.

4. Mark the cue points on the timeline.

5. Record the required sound with your cell phone or synthesize with Vital Synth. Also you are free to use recorded sound samples downloaded from internet such as [freesound.org](http://freesound.org) or refer to list of [sources](https://teaching.alptugan.com/Courses/COD-323-Sound-Design#sound-sample-library).

6. Adjust timing of the sound and sync precisely with the movie scene.

7. Export the video with sound in <font color="#ffc000">mp4</font> format and submit it to <font color="#ffc000">LMS</font>.


**Assignment 2 (Practice): Sound Sample Pack:**  
1. Find at least 5 different objects to record their sounds. It can be anything e.g. a chain, metal forks, a vase, toys, clothes, constructional material, soundscape of an environment...  
  
2. Record their sounds in the sound studio at ÖZÜ, or in an isolated environment of your choice. Keep in mind, you need to record the sound as clean as possible. We don't want any background noise. For example; You want to record the clang of a vase. Be sure that there is no background sound while you are recording the clang sound like inhale/exhale of someone, barking a dog, or an exhaust sound of a car passing outside. If that happens, record it again. Otherwise it doesn't work at all.  
  
3. Edit, split and apply only EQ filter, if necessary, on Davinci Resolve. Export each sound in "wav" format. Do not export them as "mp3"!!!  
  
4. Group similar sound effects into a folder named with the material you used. For example; You recorded 3 different clang effects using the vase. Give name to each sound as; "vase-1-short-shot.wav", "vase-2-short-shot.wav", "vase-3-long-shot.wav" respectively.  
  
5. Upload all the sounds on Google drive.  
...
[Automation via conventional methods](https://www.youtube.com/watch?v=WVzSJ5Y5Y-k)

[Automation via gestures](https://www.youtube.com/watch?v=QL2ajX4Pj3c) Get Background Music Levels RIGHT with AUTOMATED FADERS in Fairlight

[Pitch Effect](https://www.youtube.com/watch?v=Ps2Ci9ClJpQ)

[Loudness](https://www.youtube.com/watch?v=2pg8Q9FulSY)
...
Effects
[EQ, Far/near sound with](https://teaching.alptugan.com/Tutorials/Davinci-Resolve---EQ-Effects)
Reverb, End scene
...
**Examples:**
- [Jakub Ambroziak - Plasma Gun Sound Design - YouTube](https://www.youtube.com/watch?v=NZ6BBxhhRBA)
- [SciFi Plasma Gun - Sound Design - YouTube](https://www.youtube.com/watch?v=fYD7ZMoQxbs)
- [Sci-Fi Weapon Gun Sound Design - YouTube](https://www.youtube.com/watch?v=_pTsye_YJ-A)
...
### week 02 - DAW, Tools, Recording, Synthesis
- DAWs
- Davinci Resolve, Reaper
- Live Coding Tools
- Electronics

### week 03 - Sampling, Music Concrète
...
### week 04 - Haptic Interfaces, Circuit Bending
Basic sound synthesizer via electronics, [Handmade Electronic Music by Nicolas Collins](zotero://open-pdf/library/items/9RVFSXJL?page=1)


### week 05 - Audiovisual Interfaces
- MAX
- Touch Designer
- P5JS
- Strudel
