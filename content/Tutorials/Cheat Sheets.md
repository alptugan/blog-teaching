...
## gcc
| gcc --version | Display c++ compiler |
| ------------- | -------------------- |
...
## lm-sensors
| sudo apt install lm-sensors | Install Mainboard sensor drivers |
| --------------------------- | -------------------------------- |
...
| lsblk  | Display list of HDD block devices.                |
## nvidia-smi
...
## scp
|                                                                               | Secure Copy Files Between Remote Devices |
| ----------------------------------------------------------------------------- | ---------------------------------------- |
...
## uname
|                               | 32-Bit: armv6l,armv7l,armv8,armhf<br>64-Bit: arm64, aarch64 |
| ----------------------------- | ----------------------------------------------------------- |
...
## udisksctl
| udisksctl status | Display HDD brand names withing /dev |
| ---------------- | ------------------------------------ |

## timedatectl
| timedatectl list-timezones                        | List time zone names        |
| ------------------------------------------------- | --------------------------- |
