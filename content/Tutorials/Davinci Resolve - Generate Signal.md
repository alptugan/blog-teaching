...
## 1. Create Timeline
First things first create a timeline to add audio tracks. To do so, follow the instructions on [[Davinci Resolve - Create Fairlight Project]] article.
