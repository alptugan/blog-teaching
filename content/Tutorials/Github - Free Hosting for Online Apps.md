...
![](https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcodetheweb.blog%2Fassets%2Fimg%2Fposts%2Fgithub-pages-free-hosting%2Fcover.png&f=1&nofb=1&ipt=ede7f0feccd5c0f46d4c94357dceec58c6e9b859ff4295e6ccdc0496b41c525e&ipo=images)
...
Refer to the following article [[Github - Setup Personal Account]].

## 2. Create Your First Repository
Let's create our very first repository and publish our p5JS application to the public internet with a custom domain name. Hit <font color="#00b050">New</font> button to create your first public repository.
...
After you created the repository, you will see the following page in your browser. Click <font color="#0070c0"><u>uploading an existing file</u></font> hyperlink.

![[github07.jpeg]]

Now we need to upload files. Open your p5JS AR application assignment link in the browser and download the project (the same way when you are submitting your homework to ÖZÜ LMS). 

![[github08.png]]

Drag and drop all files inside the folder as shown below.<font color="#ff0000"> Do not upload the folder</font>. Just <font color="#00b050">files inside the folder</font>. Wait for all of the files to be uploaded. 

![[github09.jpeg]]

After the uploading done successfully, hit the <span style="background:rgba(3, 135, 102, 0.2)"> Commit changes </span> button to proceed changes in your newly created repository.
![[github10.jpeg]]

## 4. Publish the App on Internet
...
> [!NOTE] https://alptuganozu.github.io/projectAR/
...
## References
- [A beginner's guide to getting your website online with GitHub Pages • Code The Web](https://codetheweb.blog/github-pages-free-hosting/)
